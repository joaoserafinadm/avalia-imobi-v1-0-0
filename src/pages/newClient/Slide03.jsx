            ...
            <div className="col-12 fadeItem">
                <div className="row pb-5">
                    ...
                    <div class="form-check my-1">
                        <input class="form-check-input" type="checkbox" value="Ótima posição solar" checked={newClientForm.features.includes("Ótima posição solar")} id="posicaoSolarItem" onClick={(e) => handleFeature(e.target.value)} />
